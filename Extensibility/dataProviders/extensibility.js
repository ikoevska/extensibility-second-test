...
(function() {
    var provider = app.data.extensibility = new Everlive({
            offlineStorage: true,
            appId: 'g407o71w714xys5r',
            scheme: 'https',
            authentication: {
                persist: true
            }
        }),
        accessTokenCacheKey = 'extensibility_access_token',
...
// START_CUSTOM_CODE_extensibility
// Add custom code here. For more information about custom code, see http://docs.telerik.com/platform/screenbuilder/troubleshooting/how-to-keep-custom-code-changes

// END_CUSTOM_CODE_extensibility